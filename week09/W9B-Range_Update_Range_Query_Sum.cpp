...
struct Node{
    ...
    void update(int l, int r, int ql, int qr, int v){
        ...
        int mid = l + ((r - l) >> 1);
        push(l, r);
        lch -> update(l, mid, ql, qr, v);
        rch -> update(mid + 1, r, ql, qr, v);
        pull();
    }
    int query(int l, int r, int ql, int qr){
        ...
        int mid = l + ((r - l) >> 1);
        push(l, r);
        return lch -> query(l, mid, ql, qr) + rch -> query(mid + 1, r, ql, qr);
    }
};
...
int32_t main(){
    ...
    while(q--){
        ...
        if(k == 1){
            int l, r, u;
            cin >> l >> r >> u;
            root -> update(1, n, l, r, u);
        }
        else{
            int l, r;
            cin >> l >> r;
            cout << root -> query(1, n, l, r) << endl;
        }
    }
