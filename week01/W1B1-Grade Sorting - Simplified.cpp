...
bool cmp(stu &a, stu &b){
    ...
    if(a.sc[1] != b.sc[1]) return a.sc[1] > b.sc[1];
    if(a.sc[2] != b.sc[2]) return a.sc[2] > b.sc[2];
    if(a.sc[3] != b.sc[3]) return a.sc[3] > b.sc[3];
    if(a.sc[4] != b.sc[4]) return a.sc[4] > b.sc[4];
    return a.sc[5] > b.sc[5];
}
